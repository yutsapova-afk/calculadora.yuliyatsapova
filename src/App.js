    ...
    <div className="p-4 rounded-xl" style={{ backgroundColor: hl ? COLORS.primary : COLORS.accent, color: hl ? 'white' : COLORS.primary }}>
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex gap-6 text-center">
          <div><p className="text-xs" style={{ opacity: 0.6 }}>Alcance</p><p className="font-bold text-lg">{formatNum(reachN)}</p></div>
          <div><p className="text-xs" style={{ opacity: 0.6 }}>Publicações</p><p className="font-bold text-lg">{pubs}</p></div>
          <div><p className="text-xs" style={{ opacity: 0.6 }}>Semanas</p><p className="font-bold text-lg">{weeks}</p></div>
        </div>
      </div>
    </div>
  );
...
const DoubleSalesCalculator = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: COLORS.bg }}>
      ...
      <nav className="sticky top-0 z-50 py-3 px-4 border-b shadow-sm" style={{ backgroundColor: COLORS.bg, borderColor: COLORS.border }}>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        {activeTab === 'useful' && (
          <div className="space-y-8">
            ...
            <section className="rounded-3xl p-6 shadow-xl text-white" style={{ backgroundColor: COLORS.primary }}>
              <h2 className="text-xl font-bold mb-6">Dicas</h2>
              <div className="space-y-3">
                {[
